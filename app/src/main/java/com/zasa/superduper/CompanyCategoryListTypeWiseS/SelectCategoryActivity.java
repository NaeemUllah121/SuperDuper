...
public class SelectCategoryActivity extends AppCompatActivity {
    ...
    AutoCompleteTextView tv_category, et_Area, et_City, et_Country;
    TextInputLayout til_selectCity,til_selectArea,til_selectCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = SelectCategoryActivity.this;
