...
public class TopDiscountsAdapter extends RecyclerView.Adapter<TopDiscountsAdapter.ViewHolder> {
    float Discount_Percentage, Discount_Value, new_Item_Sale_Price;
    float Value, Price;

    private ArrayList<com.zasa.superduper.CategoryListCompanyWise.ChildItemList> ChildItemList;

    Context context;


    public TopDiscountsAdapter(ArrayList<com.zasa.superduper.CategoryListCompanyWise.ChildItemList> childItemList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rcv_top_discounts_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder childViewHolder, int position) {
...
//        }
        ...
        childViewHolder.btn_Add_to_Cart.setOnClickListener(new View.OnClickListener() {
            @Override
