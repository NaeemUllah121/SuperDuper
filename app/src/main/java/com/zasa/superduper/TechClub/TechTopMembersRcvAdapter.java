...
public class TechTopMembersRcvAdapter extends RecyclerView.Adapter<TechTopMembersRcvAdapter.ViewHolder>{

    ArrayList<TechMemTypeListModel> techMemTypeListModelArrayList;

    ArrayList<TechTopMembersListModel> techTopMembersListModelArrayList;
    Context context;

    public TechTopMembersRcvAdapter(ArrayList<TechTopMembersListModel> techTopMembersListModelArrayList, Context context) {
        this.techTopMembersListModelArrayList = techTopMembersListModelArrayList;
        this.context = context;
    }

    @NonNull
    @Override
    public TechTopMembersRcvAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rcv_tech_top_member_item, parent, false);
        return new TechTopMembersRcvAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TechTopMembersRcvAdapter.ViewHolder holder, int position) {

        String Member_Unique = techTopMembersListModelArrayList.get(position).getMember_Unique();
        String Member_FName = techTopMembersListModelArrayList.get(position).getMember_FName();
        String Member_LName = techTopMembersListModelArrayList.get(position).getMember_LName();
        String Tech_Tagline = techTopMembersListModelArrayList.get(position).getTech_Tagline();
        int Tech_Member_Type = techTopMembersListModelArrayList.get(position).getTech_Member_Type();
        long Tech_Points = techTopMembersListModelArrayList.get(position).getTech_Points();
    ...
    public int getItemCount() {
        return techTopMembersListModelArrayList.size();
    }
